...
function removeFirstAndLast(string) {
    let szoveg = string.split(",")
    
    let  returned 
    let counter = 1
    for(let i = 0; i<= szoveg.length;i++){
        if(counter != 1 || counter != szoveg.length){
...
function dnaStrand(dna){
    ...
    for(let i = 0; i <= array.length; i++){
       if(array[i] == "A") returnedArray.push("T")
       else if(array[i] == "T") returnedArray.push("A")
       else if(array[i] == "C") returnedArray.push("G")
       else if(array[i] == "G") returnedArray.push("C")
    }
...
function deEmojify(emojiString) {
    ...
    for(let i = 0; i<= emojiString.length; i++){
        if(array[i] == ":)") returnedArray.push("0")
        else if(array[i] == ":D") returnedArray.push("1")
        else if(array[i] == "C") returnedArray.push("G")
        else if(array[i] == "G") returnedArray.push("C")
